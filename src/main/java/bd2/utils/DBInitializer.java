...
public class DBInitializer {
  ...
  public void prepareDB() throws Exception {
    ...
    Product product010 = this.service.createProduct(
        "Lavarropas  automático Samsung WW90J5410G inverter plata 9kg 220 V", 2052.0F, lavarropasyLavasecarropas);
    Product product011 = this.service.createProduct(
        "Lavarropas  automático Samsung WW90J5410G inverter blanco 9kg 220 V", 2348.0F, lavarropasyLavasecarropas);
    ...
    Product product015 = this.service.createProduct("Lavavajillas Whirlpool WSFO3T2 de 10 cubiertos blanco 220V - 240V",
        4229.0F, lavavajillas);
    Product product016 = this.service.createProduct("Lavavajillas Whirlpool WLV14 de 14 cubiertos blanco 220V - 240V",
        3053.0F, lavavajillas);
    Product product017 = this.service.createProduct("Lavavajillas Whirlpool WLV14 de 14 cubiertos plateado 220V - 240V",
        739.0F, lavavajillas);
    ...
    Product product022 = this.service.createProduct(
        "Extractor purificador cocina TST Atuel ac. inox. de pared 600mm x 40mm x 510mm acero inoxidable 220V", 7831.0F,
    ...
    Product product025 = this.service.createProduct("Extractor De Aire Purificador De Cocina Embassy 3 Veloc", 240.0F,
        extractoresyPurificadores);
    ...
    Product product027 = this.service.createProduct(
        "Extractor purificador cocina Eslabón de Lujo EAB60AB empotrable 60cm x 15cm x 51cm blanco 220V", 905.0F,
        extractoresyPurificadores);
    ...
    Product product028 = this.service.createProduct(
        "Aire acondicionado BGH split frío/calor 2967 frigorías blanco 220V BS35WCCR", 2556.0F, airesAcondicionados);
    ...
    Product product032 = this.service.createProduct(
        "Aire acondicionado Hyundai split inverter frío/calor 2924 frigorías blanco 220V HY6INV-3200FC", 1538.0F,
        airesAcondicionados);
    ...
    Product product036 = this.service.createProduct("Liquido Ablandador De Durezas Fuerte Dr. Duval X 1000cc", 7755.0F,
        ablandadoresdeAgua);
    ...
    Product product039 = this.service.createProduct("Anafe eléctrico Nura NR-HP1500PM  negro 220V - 240V", 4087.0F,
        anafes);
    Product product040 = this.service.createProduct("Anafe a gas Florencia Flor 6748I  acero inoxidable 220V", 2867.0F,
        anafes);
    ...
    Product product045 = this.service.createProduct(
        "Cocina Whirlpool WFX57DI  multigas 4 hornallas  acero inoxidable 220V puerta  con visor", 3594.0F, cocinas);
    Product product046 = this.service
        .createProduct("Cocina Florencia Recta 5517F  multigas 4 hornallas  negra puerta  con visor", 4012.0F, cocinas);
    ...
    Product product048 = this.service
        .createProduct("Cocina Escorial Master  multigas 4 hornallas  blanca 220V puerta  con visor", 5247.0F, cocinas);
    Product product049 = this.service.createProduct(
        "Cocina Florencia Recta 5518F  multigas 4 hornallas  acero inoxidable puerta  con visor", 6266.0F, cocinas);
    Product product050 = this.service
        .createProduct("Cocina Escorial Candor  multigas 4 hornallas  blanca 220V puerta  con visor", 5553.0F, cocinas);
    Product product051 = this.service.createProduct("Cocina Industrial Saho Jitaku 55 Visor - Ahora 18 + Envio Sc",
        7335.0F, cocinas);
    Product product052 = this.service.createProduct("Cocina Industrial Saho Jitaku 550 Visor + Envio Sin Cargo", 342.0F,
        cocinas);
    ...
    Product product055 = this.service.createProduct("Caldera Mural Orbis 230cto Calefaccion 30000 Kcal + Envio",
        2132.0F, calderas);
    Product product056 = this.service.createProduct("Caldera A Gas Baxi Eco 4s 24 Doble Servicio Tiro Forzado", 3726.0F,
        calderas);
    ...
    Product product065 = this.service.createProduct("Dispenser Agua Fresca Caliente Mesada Para Red Jetcooler", 2367.0F,
        dispensersdeAgua);
    ...
    Product product082 = this.service.createProduct(
        "Planchita de pelo BaByliss PRO Nano Titanium 2091 BABNT2091T azul 220V", 1607.0F, artefactosparaelCabello);
    ...
    CreditCardPayment purchase013_payment = this.service.createCreditCardPayment("MasterCard Silvia Sáez", "MasterCard",
        463038870349L, sdf.parse("22/10/2021"), 294, "Silvia Sáez");
    ...
    CreditCardPayment purchase026_payment = this.service.createCreditCardPayment("MasterCard Ana Muñoz", "MasterCard",
        677254373523L, sdf.parse("2/8/2024"), 614, "Ana Muñoz");
    ...
    CreditCardPayment purchase029_payment = this.service.createCreditCardPayment("MasterCard Ana Rubio", "MasterCard",
        518081428259L, sdf.parse("3/5/2023"), 395, "Ana Rubio");
    ...
    CreditCardPayment purchase033_payment = this.service.createCreditCardPayment("MasterCard Paula Moya", "MasterCard",
        502771204572L, sdf.parse("11/10/2022"), 76, "Paula Moya");
    ...
    CreditCardPayment purchase040_payment = this.service.createCreditCardPayment("Amex Luz Muñoz", "Amex", 91128320942L,
        sdf.parse("22/8/2021"), 594, "Luz Muñoz");
    ...
    CreditCardPayment purchase046_payment = this.service.createCreditCardPayment("MasterCard María Calvo", "MasterCard",
        654998459692L, sdf.parse("25/6/2025"), 559, "María Calvo");
    ...
    this.service.createPurchase(pos091, 10, user017, delivery07, purchase060_payment, "Calle 58 Nº1686", -34.928062F,
        -57.953946F, sdf.parse("26/9/2019"));
    ...
    CreditCardPayment purchase070_payment = this.service.createCreditCardPayment("MasterCard Luz Montero", "MasterCard",
        199450179096L, sdf.parse("28/9/2021"), 160, "Luz Montero");
    ...
    this.service.createPurchase(pos022, 10, user076, delivery08, purchase102_payment, "Calle 41 Nº1034", -34.915525F,
        -57.934385F, sdf.parse("25/2/2020"));
