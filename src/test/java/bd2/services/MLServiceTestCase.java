...
public class MLServiceTestCase {
    ...
    // assertEquals(Float.valueOf(175F), (Float) pos2.getPrice());
    ...
    // assertEquals(
    // "Ya existe un precio para el producto con fecha de inicio de vigencia
    // posterior a la fecha de inicio dada",
    // ex.getMessage());
    // }
    //
    @Test
